export default (data, action) => {
  ...
  if (action.display === 'desktop') {
    ...
    previousValue = element.displayPosition && element.displayPosition[action.display] && element.displayPosition[action.display][action.property];
    changedElement = Object.assign({}, element, {
      displayPosition: Object.assign({}, element.displayPosition || {}, {
        [action.display]: Object.assign({}, element.displayPosition && element.displayPosition[action.display] || {}, {
          [action.property]: action.value
        })
      })
    });
