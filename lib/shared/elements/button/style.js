  ...
  rules: (props) => {
    const rules = {
      button: {
        ...
        '*': {
          color: props.useColor && `${getColorString(props.color)} !important`
        },
        ':hover': {
          '*': {
            color: props.useColorOver && `${getColorString(props.colorOver)} !important`
          },
        ...
        ':active': {
          '*': {
            color: props.useColorPressed && `${getColorString(props.colorPressed)} !important`
          },
