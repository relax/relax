...
export function elementAddSchemaLink ({elementId, property, prefix, context}) {
  return (dispatch, getState) => {
    ...
    const {overedId, data} = state.pageBuilder;
    const overedElement = overedId && data[overedId];
...
export function addElementAt (element, destination, context) {
  return {
    type: actionTypes.pbDoAction,
    action: {
      type: 'new',
...
export function linkFormDataMode (elementId, context) {
  return {
...
export function closeLinkFormDataMode (elementId, context) {
  return {
...
export function makeElementSymbol (elementId, title, context) {
  return (dispatch, getState) => {
    const symbolData = {};
    const draftData = getState().pageBuilder.data;
...
export function editSymbol (elementId, data) {
  return {
...
export function saveSymbol (symbolId, elementId) {
  return (dispatch, getState) => {
    const data = getState().pageBuilder.symbolsData[elementId].data;
