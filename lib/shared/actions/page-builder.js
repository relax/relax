...
import pageBuilderElements from 'elements';
...
export function save () {
  return (dispatch) => {
    ...
    dispatch(saveDraft())
      ...
      .fin(() => {
        dispatch(closePushChangesConfirmation());
      });
  };
}
...
export function drop () {
  return (dispatch) => {
    ...
    dispatch(dropDraft())
      ...
      .fin(() => {
        dispatch(closeDropDraftConfirmation());
      });
  };
}

export function openDropDraftConfirmation () {
  return {
    type: actionTypes.openDropDraftConfirmation
  };
}

export function closeDropDraftConfirmation () {
  return {
    type: actionTypes.closeDropDraftConfirmation
  };
}

export function openPushChangesConfirmation () {
  return {
    type: actionTypes.openPushChangesConfirmation
  };
}

export function closePushChangesConfirmation () {
  return {
    type: actionTypes.closePushChangesConfirmation
  };
}

export function openUnpublishConfirmation () {
  return {
    type: actionTypes.openUnpublishConfirmation
  };
}

export function closeUnpublishConfirmation () {
  return {
...
export function createStyleFromSelectedElement (title, fromStyle) {
  return (dispatch, getState) => {
    ...
    const ElementClass = pageBuilderElements[selectedElement.tag];
...
export function addLink ({elementId, schemaId, linkElementId, property, prefix, context, goal}) {
  return (dispatch, getState) => {
...
export function draggedComponent (dragInfo, dropInfo) {
  const action = {
    type: dragInfo.type,
    context: dragInfo.context // context can be any (doc property must be the same)
  };
...
export function makeElementSymbol (elementId, title, context) {
  return (dispatch, getState) => {
    const symbolData = {};
    const draftDoc = getContextFragment(getState().pageBuilder, context).doc;
    const draftData = draftDoc[context.property];
...
export function saveSymbol (symbolId) {
  return (dispatch, getState) => {
    const data = getState().pageBuilder.fragments[symbolId].doc.data;
...
export function changeDocProperty (property, value) {
  return {
    type: actionTypes.pbDoAction,
    action: {
