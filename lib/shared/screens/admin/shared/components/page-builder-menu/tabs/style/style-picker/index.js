...
export default class StylePickerContainer extends Component {
  ...
  async saveStyle () {
    ...
    if (selectedStyle === 'no_style') {
      const {selected, selectedElement} = this.props;
      const style = {
      ...
      await this.props.saveStyle(this.constructor.fragments, selected.id, style, selected.context);
      this.setState({
        editingTitle: false,
        titleValue: ''
      });
  ...
  onChangeValue (key, value) {
    ...
    if (selectedStyle === 'no_style') {
      ...
      changeElementStyle(selected.id, key, value, selected.context);
    } else {
  ...
  onChange (value) {
    ...
    changeElementProperty(selected.id, 'style', value, selected.context);
    this.setState({
      editing: true
    });
  }
