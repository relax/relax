...
import MailSettings from 'screens/admin/screens/settings/screens/mail';
...
export default [
  <Route name='admin' path='/admin' component={Admin}>
    ...
    <Route name='adminSettings' path='settings' menu={SettingsMenu}>
      ...
      <Route name='adminMailSettings' path='mail' component={MailSettings} onEnter={authenticate} />
    </Route>
    ...
    <Route name='adminSchemas' path='schemas'>
      ...
      <Route name='adminSingleSchema' path='single/:id'>
        <Route name='adminSingleSchemaEdit' path='edit' component={SchemaEdit} />
        <Route component={Schema} menu={SchemaMenu}>
          <IndexRoute onEnter={authenticate} />
