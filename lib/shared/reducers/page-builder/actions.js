...
import getActiveContextFragment from './helpers/get-active-context-fragment';
import getContextFragment from './helpers/get-context-fragment';
import updateContextFragment from './helpers/update-context-fragment';
...
export default (state, action) => {
  ...
  switch (action.type) {
    case actionTypes.pbDoAction: {
      ...
      let resultActions = pageAction.actions;
    ...
    case actionTypes.makeElementSymbol: {
      const {elementId, symbol, context} = pageAction;
