...
Css.prototype.setBackground = function setBackground (layers) {
  if (this.valid && layers && layers.constructor === Array && layers.length) {
    ...
    this.rules.background = background.reverse().toString();
    this.rules.backgroundSize = backgroundSize.reverse().toString();
    this.rules.backgroundPosition = backgroundPosition.reverse().toString();
    this.rules.backgroundRepeat = backgroundRepeat.reverse().toString();
  }
